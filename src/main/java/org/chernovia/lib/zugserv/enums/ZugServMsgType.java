...
public enum ZugServMsgType {
    none, version, ip, ipReq, ping, obs, unObs, reqLogin, logOK, noLog, errMsg, errServMsg, alertMsg, servMsg, servUserMsg,
    areaUserMsg, areaMsg, roomUserMsg, roomMsg, privMsg, phase, msgHistory, seekCreated, seekMatched,
